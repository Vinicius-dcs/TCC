...
$_SESSION['relatorio'] = "relatorio-5";
...
<body>
    ...
    <div class="container">
        ...
        <div class="mt-5">
            <p class="text-center fs-1">Relatório de Testes Drives</p>
        </div>
            ...
            <table class="table table-hover mt-4" style="font-size: 85%;">
                ...
                <tbody>
                    ...
                    if (isset($_SESSION['dataInicio']) && isset($_SESSION['dataFim'])) {
                        ...
                        $request = $relatoriosDAO->getRelatorio5();
                        ...
                        foreach ($request as $item) { ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo ucfirst($item['Nome Cliente']); ?></td>
                                <td><?php echo ucfirst($item['Veículo']); ?></td>
