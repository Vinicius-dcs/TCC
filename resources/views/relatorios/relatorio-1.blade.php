...
$_SESSION['relatorio'] = "relatorio-1";
...
<body>
    ...
    <div class="container">
        ...
        <div class="mt-5">
            <p class="text-center fs-1">Veículos com Mais Agendamentos de Testes Drives</p>
        </div>
            ...
            <table class="table table-hover mt-4" style="font-size: 85%;">
                ...
                <tbody>
                    ...
                    if (isset($_SESSION['dataInicio']) && isset($_SESSION['dataFim'])) {
                        ...
                        $request = $relatoriosDAO->getRelatorio1();

                        foreach ($request as $item) { ?>

                            <tr>
                                <td><?php echo $item['ID Veículo']; ?></td>
